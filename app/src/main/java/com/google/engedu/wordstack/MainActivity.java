...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onStartGame(View view) {
        ...
        LinearLayout word1LL = findViewById(R.id.word1);
        LinearLayout word2LL = findViewById(R.id.word2);
        ...
        Log.i("test", "Word 1: " + word1);
        randomInt = random.nextInt(words.size());
        word2 = words.get(randomInt);
        Log.i("test", "Word 2: " + word2);
        ...
        for(int count = counter1; count < WORD_LENGTH; count++){
            letterArray[arrayCount] = word1.charAt(count);
            arrayCount++;
        }

        for(int count = counter2; count < WORD_LENGTH; count++){
            letterArray[arrayCount] = word1.charAt(count);
            arrayCount++;
        }
